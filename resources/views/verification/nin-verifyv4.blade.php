                        ...
                        <div class="card-body ">
                            <div class="alert alert-warning shadow-sm">
                                <center><svg class="d-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    ...
                                    <p class="fw-bold text-danger">Note: &#x20A6;{{ $ServiceFee->amount }} will be charged
                                        for
                                        every verification attempt, regardless of the outcome. Please ensure you have
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/nin-v4.js') }}"></script>
    <script>
