                        ...
                        <div class="card-body ">
                            <div class="alert alert-warning shadow-sm">
                                <center><svg class="d-block" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    ...
                                    <p class="fw-bold text-dark"> Note that &#x20A6;{{ $ServiceFee->amount }} fee will be
                                        deducted from your wallet balance for each successful verification attempt only
                                        ,Please confirm you have sufficient funds in your wallet before proceeding with
                                        the verification. Note v3 only comes with basic information
                                </center>
                            </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-12 ">
                                                ...
                                                <input type="text" id="nin" name="nin" value=""
                                                    class="form-control text-center" placeholder="Enter NIN Number"
                                                    maxlength="11" required />
                                            </div>
                                            <div class="col-md-12 mx-auto">
                                            </div>
                                        </div>
                                        <p class="mt-1 mb-2">FEE: &#x20A6;{{ $ServiceFee->amount }}</p>
...
@push('scripts')
    ...
    <script src="{{ asset('assets/js/nin-v3.js') }}"></script>
    <script>
