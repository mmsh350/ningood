...
@section('title', 'CAC Business Reg List')
@push('styles')
                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Business Registration List(CAC)</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form method="GET" action="{{ route('admin.business-reg') }}"
                            ...
                            <div class="table-responsive">
                                <table class="table text-nowrap" style="background:#fafafc !important">
                                    ...
                                    <tbody>
                                        @foreach ($registrationList as $service)
                                            <tr>
                                                <td> {{ $loop->iteration }}</td>
                                                <td>{{ $service->refno }}</td>
                                                <td>{{ $service->business_name_1 }}</td>
                                                ...
                                                <td>
                                                    @if ($service->user && $service->status !== 'failed')
                                                        <a href="{{ route('admin.view-request3', [$service->id, $request_type]) }}"
                            ...
                            <div class="d-flex justify-content-center mt-3">
                                {{ $registrationList->links('pagination::bootstrap-5') }}
                            </div>
                        </div>
                    </div>
                </div>
