                ...
                <div class="col-xl-12">
                    <div class="card custom-card ">
                        <div class="card-header">
                            <h5 class="card-title">Mod IPE Clearance Request</h5>
                        </div>
                        <div class="card-body">
                            @if (session('success'))
                            ...
                            <form method="GET" action="{{ route('admin.modipe.index') }}"
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-2 mb-2">
                                        <a href="{{ route('admin.export.modipe') }}" class="btn btn-outline-danger w-100">
                                    ...
                                    <tbody>
                                        @foreach ($nin_services as $service)
                                            <tr>
                                                ...
                                                <td>{{ $service->tracking_id }}</td>
                                                <td>{{ $service->transactions->service_description }}</td>
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h6 class="modal-title" id="staticBackdropLabel2">Reply (#<span id="sid"></span>)
                                </h6>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reply').on('shown.bs.modal', function(event) {
                ...
                const requestType = 'NIN Mod IPE';
                const actionUrl = `/admin/requests/${requestId}/${requestType}/update-mod-ipe-status`;
